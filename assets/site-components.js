...
<div class="flex justify-between items-center w-full px-margin-mobile md:px-margin-desktop py-2.5 sm:py-3 max-w-container-max mx-auto">
  ...
  <div class="hidden lg:flex items-center gap-1 xl:gap-2">
    ...
    <a class="text-on-surface-variant hover:text-secondary font-label-md text-label-md transition-all hover:bg-surface-container-low px-3.5 py-2.5 min-h-[44px] inline-flex items-center rounded-lg" href="about.html#careers">Careers</a>
...
<div id="mobile-nav-panel" class="hidden lg:hidden px-4 sm:px-6 py-4 bg-surface-container-lowest border-t border-outline-variant max-h-[85vh] overflow-y-auto space-y-2 shadow-xl">
  ...
  <a class="min-h-[48px] flex items-center px-4 py-3 rounded-xl text-on-surface-variant hover:text-secondary active:bg-surface-container-low transition-all text-base border-b border-outline-variant/20" href="about.html#careers">
  ...
  <div class="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-stack-lg flex flex-col lg:flex-row justify-between gap-10 lg:gap-16">
    ...
    <div class="lg:w-1/3">
      <a class="flex items-center gap-2 mb-4 inline-block min-h-[44px]" href="index.html" aria-label="SolarQube Home">
        <img alt="SolarQube Energy" class="h-12 w-auto object-contain" src="/assets/logo/solarqube-logo-white.png"/>
      </a>
      <p class="font-body-md text-body-md text-on-primary/80 max-w-sm mb-6 leading-relaxed">
        SolarQube Energy delivers turnkey solar EPC solutions for homes, businesses, and industrial facilities across Jalakandapuram, Salem, Erode, Tharamangalam, and surrounding areas.
      </p>
      
      <!-- Social Media Links (Icons with 44x44px minimum tap targets) -->
      <div class="flex items-center gap-3 mb-6">
        <a class="w-11 h-11 min-w-[44px] min-h-[44px] rounded-full bg-white/10 hover:bg-[#29C5F0] hover:text-[#001430] text-white flex items-center justify-center transition-all duration-200 hover:scale-110 active:scale-95 shadow-sm" href="https://www.instagram.com/solarqubeenergy.in/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
        ...
        <a class="w-11 h-11 min-w-[44px] min-h-[44px] rounded-full bg-white/10 hover:bg-[#29C5F0] hover:text-[#001430] text-white flex items-center justify-center transition-all duration-200 hover:scale-110 active:scale-95 shadow-sm" href="https://www.facebook.com/profile.php?id=61590748341959" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
          <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
        </a>
        <a class="w-11 h-11 min-w-[44px] min-h-[44px] rounded-full bg-white/10 hover:bg-[#29C5F0] hover:text-[#001430] text-white flex items-center justify-center transition-all duration-200 hover:scale-110 active:scale-95 shadow-sm" href="https://www.linkedin.com/company/115253981/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
          <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
        </a>
        <a class="w-11 h-11 min-w-[44px] min-h-[44px] rounded-full bg-white/10 hover:bg-[#29C5F0] hover:text-[#001430] text-white flex items-center justify-center transition-all duration-200 hover:scale-110 active:scale-95 shadow-sm" href="https://www.youtube.com/channel/UCpQ6kf_7mincGOXFvaDRvvA" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
    ...
    <div class="lg:w-2/3 grid grid-cols-1 sm:grid-cols-3 gap-8">
      <!-- Quick Links -->
      <div>
        <h4 class="font-label-md text-label-md font-bold mb-4 text-[#7490c3] uppercase tracking-wider text-sm">Quick Links</h4>
        <ul class="space-y-1">
          <li><a class="font-body-md text-body-md text-on-primary/80 hover:text-[#29C5F0] transition-colors min-h-[44px] inline-flex items-center py-2 ${active === 'about' ? 'text-white font-bold' : ''}" href="about.html">About Us</a></li>
          <li><a class="font-body-md text-body-md text-on-primary/80 hover:text-[#29C5F0] transition-colors min-h-[44px] inline-flex items-center py-2 ${active === 'residential' ? 'text-white font-bold' : ''}" href="residential-solar.html">Residential Solar</a></li>
          <li><a class="font-body-md text-body-md text-on-primary/80 hover:text-[#29C5F0] transition-colors min-h-[44px] inline-flex items-center py-2 ${active === 'commercial' ? 'text-white font-bold' : ''}" href="commercial-industrial-solar.html">Commercial & Industrial</a></li>
          <li><a class="font-body-md text-body-md text-on-primary/80 hover:text-[#29C5F0] transition-colors min-h-[44px] inline-flex items-center py-2 ${active === 'canopies' ? 'text-white font-bold' : ''}" href="solar-canopies-carports.html">Solar Canopies</a></li>
          <li><a class="font-body-md text-body-md text-on-primary/80 hover:text-[#29C5F0] transition-colors min-h-[44px] inline-flex items-center py-2 ${active === 'open-access' ? 'text-white font-bold' : ''}" href="open-access-solar.html">Open Access & PPA</a></li>
          <li><a class="font-body-md text-body-md text-on-primary/80 hover:text-[#29C5F0] transition-colors min-h-[44px] inline-flex items-center py-2 ${active === 'utility' ? 'text-white font-bold' : ''}" href="utility-scale-solar.html">Utility Scale</a></li>
          <li><a class="font-body-md text-body-md text-on-primary/80 hover:text-[#29C5F0] transition-colors min-h-[44px] inline-flex items-center py-2 ${active === 'projects' ? 'text-white font-bold' : ''}" href="projects.html">Projects</a></li>
          <li><a class="font-body-md text-body-md text-on-primary/80 hover:text-[#29C5F0] transition-colors min-h-[44px] inline-flex items-center py-2 ${active === 'contact' ? 'text-white font-bold' : ''}" href="contact.html">Contact Us</a></li>
        </ul>
      </div>

      <!-- Contact Us -->
      <div>
        <h4 class="font-label-md text-label-md font-bold mb-4 text-[#7490c3] uppercase tracking-wider text-sm">Contact Us</h4>
        <ul class="space-y-1">
          <li class="flex items-start gap-3 py-2 min-h-[44px]">
            <span class="material-symbols-outlined text-[#29C5F0] text-lg mt-0.5 flex-shrink-0">location_on</span>
          ...
          <li>
            <a class="font-body-md text-body-md text-on-primary/80 hover:text-[#29C5F0] transition-colors text-sm min-h-[44px] flex items-center gap-3 py-1.5" href="tel:+918883663001">
              <span class="material-symbols-outlined text-[#29C5F0] text-lg flex-shrink-0">call</span>
              <span>+91 8883663001</span>
            </a>
          </li>
          <li>
            <a class="font-body-md text-body-md text-on-primary/80 hover:text-[#29C5F0] transition-colors text-sm min-h-[44px] flex items-center gap-3 py-1.5" href="mailto:info@solarqubeenergy.in">
              <span class="material-symbols-outlined text-[#29C5F0] text-lg flex-shrink-0">mail</span>
              <span>info@solarqubeenergy.in</span>
            </a>
          </li>
          <li class="flex items-start gap-3 pt-2">
            <span class="material-symbols-outlined text-[#29C5F0] text-lg mt-0.5 flex-shrink-0">apartment</span>
      ...
      <!-- Follow Us -->
      <div>
        <h4 class="font-label-md text-label-md font-bold mb-4 text-[#7490c3] uppercase tracking-wider text-sm">Follow Us</h4>
        <ul class="space-y-1">
          <li>
            <a class="font-body-md text-body-md text-on-primary/80 hover:text-[#29C5F0] transition-colors flex items-center gap-3 group text-sm min-h-[44px] py-1.5" href="https://www.instagram.com/solarqubeenergy.in/" target="_blank" rel="noopener noreferrer">
              <svg class="w-5 h-5 fill-current text-[#29C5F0] group-hover:scale-110 transition-transform" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>
              <span>Instagram</span>
            </a>
          </li>
          <li>
            <a class="font-body-md text-body-md text-on-primary/80 hover:text-[#29C5F0] transition-colors flex items-center gap-3 group text-sm min-h-[44px] py-1.5" href="https://www.facebook.com/profile.php?id=61590748341959" target="_blank" rel="noopener noreferrer">
              <svg class="w-5 h-5 fill-current text-[#29C5F0] group-hover:scale-110 transition-transform" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              <span>Facebook</span>
            </a>
          </li>
          <li>
            <a class="font-body-md text-body-md text-on-primary/80 hover:text-[#29C5F0] transition-colors flex items-center gap-3 group text-sm min-h-[44px] py-1.5" href="https://www.linkedin.com/company/115253981/" target="_blank" rel="noopener noreferrer">
              <svg class="w-5 h-5 fill-current text-[#29C5F0] group-hover:scale-110 transition-transform" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
              <span>LinkedIn</span>
            </a>
          </li>
          <li>
            <a class="font-body-md text-body-md text-on-primary/80 hover:text-[#29C5F0] transition-colors flex items-center gap-3 group text-sm min-h-[44px] py-1.5" href="https://www.youtube.com/channel/UCpQ6kf_7mincGOXFvaDRvvA" target="_blank" rel="noopener noreferrer">
              <svg class="w-5 h-5 fill-current text-[#29C5F0] group-hover:scale-110 transition-transform" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
              <span>YouTube</span>
            </a>
          </li>
        </ul>
